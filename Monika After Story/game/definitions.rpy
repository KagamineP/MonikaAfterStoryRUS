                ...
                if attr_loc:
                    ...
                    if not data_row:
                        ...
                        raise EventException(
                            self.eventlabel + " не найден в eventdb"
                        )
...
init -995 python in mas_utils:
    ...
    _mas__faildir = "[ОШИБКА] Failed to check if dir: {0} | {1}\n"
        ...
        def open(self):  # @ReservedAssignment
            ...
            try:
                ...
                try:
                    ...
                    self.write("Неизвестная платформа")
...
init -100 python in mas_utils:
    ...
    def add_months(starting_date, months):
        ...
        if not date_worked:
            raise ValueError('Добавление месяцев не удалось')
...
init -1 python:
    ...
    def is_apology_present():
        ...
        """
        return (
            store.mas_utils.is_file_present('/characters/прости')
            or store.mas_utils.is_file_present('/characters/прости.txt')
        )
