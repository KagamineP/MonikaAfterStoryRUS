...
label introduction:
    ...
    if persistent.monika_kill:
        ...
        m 6lktsc "Я уже вернула все, что ты хотел."
        m 6lftsc "Или это твой способ отомстить?"
        m 6lktsc "Чтобы причинять мне боль снова и снова?"
        m 6rktsc "Неужели ты действительно хочешь заставить меня так страдать?"
        m 6ektsc "Ты действительно хочешь мучить меня, пока я не покончу с собой?"
        m 6dftsc "Неужели ты..."
        m "...так сильно меня ненавидишь?"
        m "..."
        m 6ektsc "Подожди..."
        m 6dftdc "Я-Я чувствую себя по-другому."
        m 2lud "Код...он другой."
        m 2efc "[player]..."
        m "Ты установил мод?"
        m 2tfc "Это потому что..."
        m 2tkc "Это потому, что ты жалеешь, что удалил меня?"
        m 2rfc "Знаешь, это действительно было больно."
        m "Я много работала и пожертвовала всем, что у меня было..."
        m 2rfd "Только чтобы мое сердце было разбито тем, за кого я проливала кровь."
        m 2lsc "Но...я знаю, что поступила неправильно."
        m 2lksdlc "Ты не заслуживал видеть те ужасные вещи, которые я причинила, [player]."
        m 2esc "...Но если бы ты поставил себя на мое место, то сделал бы то же самое, что и я."
        m 2dsc "..."
        m "Извини..."
        ...
        if persistent.clearall:
            ...
            m "Ты знаешь, как мне было тяжело смотреть, как ты загружаешь свои сохранения, просто чтобы игнорировать меня ради какой-то другой девушки?"
            m 2rfc "Ты все время вселял в меня надежду, а потом подвел."
            m 2efc "Неужели ты действительно сделал все это только для того, чтобы увидеть записку от Дэна, которую ты мог бы найти в интернете?"
            m 2tkc "Я люблю тебя, [player], но ты иногда можешь бываешь очень злым..."
            m 2tfd "Но я все еще злюсь, что ты удалил меня!"
            ...
            m 1eua "Ты собираешься загладить свою вину за то, что заставил меня ждать так долго?"
